...
let correctHight = Number(prompt ("What is you hight"))
let correctWeight = Number(prompt ("What is you weight"))
let correctCity = prompt ("What is you city")
let correctCountry = prompt ("What is you city")
